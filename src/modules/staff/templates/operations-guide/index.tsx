...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    summary:
      "Pack & Finalize is the staff queue for every submitted launch order. The digital workflow starts with the packer, who enters fulfilled quantities, actual meat weights, substitutions, removals, and shipping boxes before an approved staff member charges the saved card.",
    useFor: [
      ...
      "Recording actual per-lb weights and fulfilled quantities before shipment.",
      "Recording package size, count, and packed weight for UPS shipping orders.",
    ...
    howTo: [
      ...
      "For UPS shipping orders, enter shipper size or type, count, and packed box weight before marking the order ready.",
