...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "If the packer finds a mismatch, use Send Back To Picking with a short reason. The order returns to the picker queue; staff can still handle the correction verbally while the super-admin audit trail records the handoff.",
    ...
    watch: [
      ...
      "Every Pack & Finalize mutation should write to the order staff timeline, including claim pick, unclaim pick, ready for packing, claim pack, line edits, added items, substitutions, removals, send back to picking, package capture, ready-for-charge, charge attempts, and fulfillment.",
