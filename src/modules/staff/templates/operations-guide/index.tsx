...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    useFor: [
      ...
      "Verifying whether WWEX / Unishippers live rating is configured or whether checkout is using fallback rates.",
    ],
    howTo: [
      ...
      "When WWEX / Unishippers Speedship credentials are configured in Medusa, checkout can quote live UPS small-parcel services. If live rating fails or is not configured, Medusa falls back to the existing Strapi shipping-zone rates.",
    ...
    watch: [
      ...
      "If rates or dates look wrong, check Medusa WWEX configuration first for live UPS rates, then Strapi fallback settings and Medusa shipping options.",
