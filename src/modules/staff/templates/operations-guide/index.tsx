...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    useFor: [
      ...
      "Recording actual per-lb item weights and fulfilled quantities before shipment.",
      "Recording shipper size, count, dry ice, and packed weight for UPS shipping orders.",
    ...
    howTo: [
      ...
      "Pickers use the Picking tab. Claim the pick, update each line as Ready, Removed, or Substituted, and keep Fulfilled at the actual picked quantity. New lines start with Fulfilled at 0.",
      ...
      "For UPS shipping orders, enter the shipper used: Micro, 330 Medium, 345 Large, or 360 Extra large. Record count, packed weight, dry ice pounds, and any package note.",
