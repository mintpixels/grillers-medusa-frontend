...
const systemMap = [
  ...
  },
  {
    ...
    details:
      "QuickBooks receives sales orders and accounting follow-up through the sync service and Web Connector. Product matching must use ListID, also called the item hex.",
  },
]
...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "Click Charge Card & Release when the order is ready to leave. If Stripe fails, do not ship the order.",
