...
const publicSurfaces = [
  ...
  },
  {
    ...
    staffUse:
      "Use when a customer asks what the optional pickup and delivery text program covers, including message limits and STOP or HELP instructions.",
  },
  {
    route: "/us/page/order-sms-privacy",
    name: "Order text privacy",
    staffUse:
      "Use when a customer asks how the phone number and order-text consent are used for pickup and delivery updates.",
  },
  {
    route: "/us/recipes",
    name: "Recipe hub",
...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    howTo: [
      ...
      "At payment, the customer may choose the separate unchecked pickup and delivery text box. It is optional, covers up to six messages for that order, and is separate from marketing-text consent.",
  ...
  },
  {
    ...
    useFor: [
      ...
      "Understanding the separate, order-scoped pickup and delivery text choice shown at checkout.",
    ...
    howTo: [
      ...
      "For pickup and delivery texts, the customer must choose the separate unchecked box during checkout. That choice applies only to that order and allows up to six messages for the order.",
      "At launch, only a real shipment or tracking event can trigger an order text. Pickup-ready texts stay off until Medusa has a real pickup-ready event; do not use Ready ship, a final charge, or a staff promise as a substitute.",
    ...
    watch: [
      ...
      "The marketing toll-free program remains marketing-only. The dedicated order-update program is separate and limited to pickup and delivery updates for an order with its own valid checkout consent.",
  ...
  },
  {
    ...
    howTo: [
      ...
      "Email remains the source for order confirmations, payments and final charges, cancellations, refunds, and fallback communication even when a customer chooses pickup and delivery texts.",
