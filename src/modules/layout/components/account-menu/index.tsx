...
export default function AccountMenu({
  ...
  const isStaffContextActive = Boolean(staffImpersonation)
  ...
  const links =
    canUseStaffTools || isStaffContextActive
      ? [
          {
            ...
            <div className="w-[200px] bg-[#FAFAF8] rounded-lg shadow-[0_4px_24px_rgba(0,0,0,0.08)] border border-Gold/30 overflow-hidden">
              ...
              <div className="px-1.5 pb-1.5">
                {links.map(({ href, label, icon }) => (
                  ...
                  >
                    <svg
                      className="w-3.5 h-3.5 text-Charcoal/40 flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={1.8}
              ...
              <div className="border-t border-Charcoal/6 px-1.5 py-1.5">
                <button
                  ...
                  disabled={isStaffContextActive ? isExiting : false}
