  ...
  if (methods.length === 0) {
    return (
      <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
        ...
        <p className="text-lg font-gyst font-bold text-Charcoal mb-2">No saved cards yet</p>
        <p className="text-sm font-maison-neue text-Charcoal/50">
          When you check out, you can choose to save a card for faster purchases next time. We never save cards without your permission.
        </p>
      </div>
    )
  }
